...
class AibonAgent():
    ...
    def create_graph(self) -> CompiledStateGraph:
        ...
        def generate_sql_query(state: AgentState):
            ...
            # generate_sql_query_prompt_template = generate_sql_query_prompt.format(
        ...
        def formulate_response(state: AgentState, config: RunnableConfig) -> AgentState:
            ...
            #     if not (msg.response_metadata and "function" in msg.response_metadata and msg.response_metadata["function"] in ["paraphrase_query"]):
    ...
    def generate_response(
        ...
        """
        Generate response based on user messages input and desired language (English or Bahasa Indonesia).
